...
h_number = input('Enter your house number: ')
s_name = input('Enter your street name: ')

print('This is ' + name + ', he is ' + age + ' old and lives at house number ' + h_number + ' on ' + s_name + ' Street. ')
